			...
			<div  style="color: white">
					<nav class="navbar navbar-expand-lg navbar navbar-dark bg-primary">
							<a class="navbar-brand" href="#">
								<img class="logo" src="/imgs/logo2.jpg">
							</a>
							...
							<div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
								<div class="navbar-nav">
									<strong><a class="nav-item nav-link active" href="/projeto/novo">Adicionar Projeto</a></strong>
									<a class="nav-item nav-link" href="#">Perfil</a>
									<a class="nav-item nav-link" href="/usuario/entrar">Sair</a>
								</div>
							</div>
						</nav>
					...
					<ul class="sidebar navbar-nav bg-light">
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="pagesDropdown">
								...
								<%-- <jsp:useBean id="projetoController" class="br.com.nottrello.controller.ProjetoController"></jsp:useBean> --%>
								<%-- <c:forEach var="projetos" items="${projetoController.listar}"> --%>
